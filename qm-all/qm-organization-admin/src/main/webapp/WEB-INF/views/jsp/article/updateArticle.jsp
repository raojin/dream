	      ...
	      <div id="page-wrapper" class="col-lg-9">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input class="hidden" name="articleId"  value="${Bean.date.articleId}"/>
                                     <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label>作者</label>
                                            <input class="form-control" name="author"  value="${Bean.date.author}">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>摘要</label>
                                           <input class="form-control" name="digest"  value="${Bean.date.digest}">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>状态</label>
                                            <div class="form-control">
                                             <label class="radio-inline">
                                                ...
                                                <c:if test="${Bean.date.status =='1'}">checked</c:if> >正常
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="optionsRadiosInline2" value="2" 
                                                <c:if test="${Bean.date.status =='2'}">checked</c:if>>隐藏
                                            </label>
                                            </div>
                                        </div>
                                         <div class="form-group col-lg-6">
                    ...
                    <!-- /.panel -->
                     <div class="form-group col-lg-6">
                        <button id="articleUpdateBtn" type="button" class="btn btn-success">修改</button>
                        <div id="updateArticleMsg" class="updateMsg"></div>
                     </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
